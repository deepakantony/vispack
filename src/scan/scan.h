...
//	cout << "yeah, we got def bitz" << endl;
  ...
  virtual float depth(const VISVector &p) const;
  virtual float depth(const VISVector &p, int scale) const;
  virtual VISVector SphericalScan::grad_depth(const VISVector &p, int scale) const;
  virtual VISVector SphericalScan::grad_conf(const VISVector &p, int scale) const;
