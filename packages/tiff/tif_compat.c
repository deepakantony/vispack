#ifndef lint
static char rcsid[] = "$Header: /uusoc/res/image/CVS/vispack/packages/tiff/tif_compat.c,v 1.2 2003-02-12 22:47:48 whitaker Exp $";
#endif
...
#if defined(unix) || defined(__unix) || defined(MSDOS) || defined(VMS) || defined(APPLE)
#include <sys/stat.h>
