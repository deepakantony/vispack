/* $Header: /uusoc/res/image/CVS/vispack/packages/tiff/machdep.h,v 1.1.1.1 2003-02-12 16:51:48 whitaker Exp $ */
...
#define	TIFFSwabVISArrayOfFloat(fp,n)  TIFFSwabVISArrayOfLong((unsigned long *)fp,n)
#define	TIFFSwabVISArrayOfDouble(dp,n) TIFFSwabVISArrayOfLong((unsigned long *)dp,2*n)
#endif /* IEEEFP */
