...
extern	int TIFFSwabVISArrayOfShort(unsigned short *, int);
extern	int TIFFSwabVISArrayOfLong(unsigned long *, int);
...
extern	int TIFFSwabVISArrayOfShort();
extern	int TIFFSwabVISArrayOfLong();
