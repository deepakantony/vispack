#ifndef lint
static char rcsid[] = "$Header: /uusoc/res/image/CVS/vispack/packages/tiff/tif_dirinfo.c,v 1.2 2003-02-12 22:47:48 whitaker Exp $";
#endif
...
/* begin SGI tags */
    ...
    { TIFFTAG_TILEDEPTH,	 1, 1, TIFF_SHORT,	FIELD_TILEDEPTH,
      FALSE,	"TileDepth" },
/* end SGI tags */
    { TIFFTAG_IMAGETRANSFORM,	 12, 12, TIFF_FLOAT,	FIELD_IMAGETRANSFORM,
      TRUE,	"ImageTransform" },
    { 0 }
};
